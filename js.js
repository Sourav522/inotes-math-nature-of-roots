...
nodeHTMLDataFinal=[['00.svg','01.svg','02.svg']];
nodeHTMLDataInitial=[['<div>D > 0</div>','<div>D < 0</div>','<div>D = 0</div>']];
node.nodeL1.innerHTML='<div>Nature of Roots</div>';
node.nodeL2[0].innerHTML='<div>Discriminant<br></div>';
node.nodeL3[0][0].innerHTML='<div>D > 0</div>';
node.nodeL3[0][1].innerHTML='<div>D < 0</div>';
node.nodeL3[0][2].innerHTML='<div>D = 0</div>';
